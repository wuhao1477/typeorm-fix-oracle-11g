...
export class ReactNativeDriver implements Driver {
    ...
    // 添加 attachedDatabases 属性
    protected attachedDatabases: DatabasesMap = {}
    ...
    /**
     * Returns true if driver has any attached databases.
     */
    ...
    /**
     * Gets the handle of attached database by its path.
     */
    ...
    /**
     * Gets the relative path of attached database by its handle.
     */
